...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <script
      src="https://kit.fontawesome.com/db59255a97.js"
  ...
  />
    <link
      rel="shortcut icon"
      href="{{ asset('assets/img/logotipos/2.svg') }}"
      type="image/x-icon"
    />
    ...
    <section class="flex justify-between min-h-[80vh]">
      <main class="w-[50%] bg-blanco h-[100%] pr-[8%]">
        <article class="flex gap-[10px] items-center animate__animated animate__fadeInLeft" >
          <div>
            <img
              src="{{ asset('assets/img/logotipos/1.svg') }}"
              alt="logotipo1"
              width="60px"
              heigth="60px"
            />
        ...
        <article class="min-h-[480px] flex flex-col justify-center animate__animated animate__fadeInUp">
          ...
          <form action="" method="post">
            ...
            <div
              class="rounded-lg border-[2px] border-gris p-[5px] flex items-center gap-[8px] my-[10px]"
            >
              <i class="fa-solid fa-circle-user text-gris"></i>
              <input
                type="text"
                class="w-full focus:outline-none focus:border-none font-medium"
                placeholder="1013580"
                name="usuario"
              />
            </div>
            ...
            >
              ...
              <i
                id="toggle-password"
                class="fa-solid fa-eye text-gris cursor-pointer"
              ></i>
            </div>
            ...
            <div class="flex items-center space-x-3 mt-[10px]">
              <label class="group flex items-center cursor-pointer">
                ...
                <span
                  class="ml-3 text-[12px] text-gray-700 font-medium transition-colors duration-300"
                >
                  Al darle click, entiendo los
                  <a href="" class="text-rojo font-semibold"
      ...
      >
        ...
        >
          ...
          <img
  src="{{ asset('assets/img/logotipos/essential.png') }}"
  alt="logo"
  width="250px"
/>
